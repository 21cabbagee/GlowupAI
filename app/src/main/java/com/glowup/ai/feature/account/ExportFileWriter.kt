...
object ExportFileWriter {
    ...
    suspend fun write(context: Context, userId: String, bundle: ExportBundle): Uri =
        withContext(Dispatchers.IO) {
            ...
            file.writeText(PrettyExportJson.encodeToString(kotlinx.serialization.json.JsonElement.serializer(), json))
