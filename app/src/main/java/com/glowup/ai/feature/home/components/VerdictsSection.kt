...
fun VerdictsSection(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        when {
            ...
            verdicts.isEmpty() && !isPremium && !features.productVerdictsUnlocked -> LockedCard(
                ...
                verdicts.forEach { verdict ->
                    if (verdict.label == VerdictLabel.LOCKED) {
                        LockedCard(
                            ...
                            body = verdict.generatedText.ifBlank {
...
private fun VerdictLabel.toWireOrRaw(): String = when (this) {
