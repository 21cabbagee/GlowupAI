...
enum class ExperimentStatus {
    ...
    companion object {
        fun fromRaw(raw: String?): ExperimentStatus =
            when (raw) {
                "planned" -> PLANNED
                "running" -> RUNNING
                "paused" -> PAUSED
...
enum class JobStatus {
    ...
    companion object {
        fun fromRaw(raw: String?): JobStatus =
            when (raw) {
                "queued" -> QUEUED
                "running" -> RUNNING
                "completed" -> COMPLETED
...
enum class EntitlementStatus {
    ...
    companion object {
        fun fromRaw(raw: String?): EntitlementStatus =
            when (raw) {
                "active" -> ACTIVE
                "cancelled" -> CANCELLED
                else -> UNKNOWN
...
enum class CaptureGuideState {
    ...
    companion object {
        fun fromRaw(raw: String?): CaptureGuideState =
            when (raw) {
...
enum class VerdictLabel {
    ...
    companion object {
        fun fromRaw(raw: String?): VerdictLabel =
            when (raw) {
                "keep" -> KEEP
...
enum class SafetyScope {
    ...
    companion object {
        fun fromRaw(raw: String?): SafetyScope =
            when (raw) {
...
enum class RoutineAction {
    ...
    companion object {
        fun fromRaw(raw: String?): RoutineAction =
            when (raw) {
                "start" -> START
                "stop" -> STOP
                "change" -> CHANGE
...
enum class CheckInRoutineState {
    ...
    companion object {
        fun fromRaw(raw: String?): CheckInRoutineState =
            when (raw) {
                "steady" -> STEADY
                "changed" -> CHANGED
                "missed" -> MISSED
...
enum class CheckInSkinFeel {
    ...
    companion object {
        fun fromRaw(raw: String?): CheckInSkinFeel =
            when (raw) {
                "better" -> BETTER
                "same" -> SAME
                "worse" -> WORSE
...
enum class ContextEventType {
    ...
    companion object {
        fun fromRaw(raw: String?): ContextEventType =
            when (raw) {
                "sleep" -> SLEEP
                "travel" -> TRAVEL
                "weather" -> WEATHER
...
enum class MeasurementAgreement {
    ...
    companion object {
        fun fromRaw(raw: String?): MeasurementAgreement =
            when (raw) {
                "fair" -> FAIR
                "uncertain" -> UNCERTAIN
                "off" -> OFF
...
enum class PrimaryMetric {
    ...
    companion object {
        fun fromRaw(raw: String?): PrimaryMetric =
            when (raw) {
