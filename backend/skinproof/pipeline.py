...
class CaptureProcessingPipeline:
    ...
    def __init__(
        ...
        self.face_aligner = FaceAligner() if enable_face_alignment else None
        self.preprocessor = ImagePreprocessor(target_size=output_size) if enable_preprocessing else None
...
_default_pipeline: Optional[CaptureProcessingPipeline] = None
