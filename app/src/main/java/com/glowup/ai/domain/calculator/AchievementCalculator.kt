...
object AchievementCalculator {
        ...
        return AchievementType.values().map { type ->
            val (progress, isUnlocked) =
                checkRequirement(
                    ...
                    usedComparison = false, // TODO: track this when comparison feature is used
    ...
    private fun checkRequirement(
        ...
        when (requirement) {
            ...
            AchievementRequirement.UsedComparison -> {
                val progress = if (usedComparison) 1f else 0f
                progress to usedComparison
            }
