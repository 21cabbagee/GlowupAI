...
class SessionRepository
    ...
    constructor(
        ...
        suspend fun refreshProfile(userId: String? = null): GlowResult<Profile> {
            val id =
                userId ?: sessionStore.userId() ?: return GlowResult.Failure(
                    com.glowup.ai.data.remote.ApiError
                        .Unknown(IllegalStateException("refreshProfile called with no stored user id")),
                )
