...
def analyze(
    ...
    darkspot_area = sum(
        1 for _, _, r, g, b in points if _luminance(r, g, b) < dark_threshold
    ) / len(points)

    candidate = {
        (x, y) for x, y, r, g, b in points if r - g > 42 and _luminance(r, g, b) > 55
    }
    blemishes = 0
    while candidate:
        seed = candidate.pop()
